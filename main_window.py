...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.Save_Win_Data_CheckBox, 2, 0, 1, 3)
        ...
        self.RevDataTextBrowser.setAcceptDrops(False)
        self.RevDataTextBrowser.setLineWidth(1)
        self.RevDataTextBrowser.setLineWrapMode(QtWidgets.QTextEdit.NoWrap)
        self.RevDataTextBrowser.setOpenExternalLinks(True)
        self.RevDataTextBrowser.setObjectName("RevDataTextBrowser")
        self.gridLayout.addWidget(self.RevDataTextBrowser, 4, 0, 3, 9)
